      ...
      <Nav/>
        ...
        <div className="button-container2">
          <div className="dropdown">
            <button className="search-button2" onClick={toggleDropdown}>Find Jobs</button>
            {isDropdownOpen && (
              <div className="dropdown-content">
                <button><Link to='/job'>SAP Consultant</Link></button>
        ...
        <img src="https://images.pexels.com/photos/9683980/pexels-photo-9683980.jpeg?auto=compress&cs=tinysrgb&w=600" height="300px" width="300px"></img>
        </div>
        <div className='amazon'>
        <img src="https://i.pinimg.com/236x/15/c2/1b/15c21bddb69f87acaea8a6e30e8e7f1e.jpg" height="300px" width="300px"></img>
        </div>
        <div className='zoho'>
        <img src="https://i.pinimg.com/236x/76/5b/d6/765bd63eea3305736e38a851d445aa0f.jpg" height="300px" width="300px"></img>
        </div>
        <div className='go'>
        <img src="https://i.pinimg.com/236x/92/f2/d5/92f2d549250958a3b7c5452f0c95ce1d.jpg" height="300px" width="300px"></img>
        </div>
        <div className='benz'>
        <img src="https://i.pinimg.com/236x/54/cc/9e/54cc9e71fa961a744e12620a02ab9960.jpg" height="300px" width="300px"></img>
        </div>
        <Footer/>
      </div>
    );
